...
type RuntimeConfig struct {
	...
	EvaluationMode                       string   `json:"evaluation_mode" yaml:"evaluation_mode" toml:"evaluation_mode"`
	EvaluationChatIDs                    []string `json:"evaluation_chat_ids" yaml:"evaluation_chat_ids" toml:"evaluation_chat_ids"`
	EvaluationCohortDurationHours        int      `json:"evaluation_cohort_duration_hours" yaml:"evaluation_cohort_duration_hours" toml:"evaluation_cohort_duration_hours"`
...
type ArkConfig struct {
	...
	ReasoningEffortModels []string `json:"reasoning_effort_models" yaml:"reasoning_effort_models" toml:"reasoning_effort_models"`
